...
async def test_prepare_response_node_error() -> None:
    ...
    body = (await prepare_response_node(state, {}))["tool_response"]
...
async def test_prepare_response_node_success() -> None:
    state = {
        "pipeline_violation": {},
        "code_execution_result": {
            "stdout": "ok\n",
...
async def test_prepare_response_node_missing_inputs_failed() -> None:
...
async def test_prepare_response_node_io_allowlist_violation() -> None:
